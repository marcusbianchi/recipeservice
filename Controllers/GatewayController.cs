...
namespace recipeservice.Controllers {
    ...
    public class GatewayController : Controller {
        ...
        [SecurityFilter ("recipes__allow_read")]
        [Produces ("application/json")]
        public async Task<IActionResult> GetParameters ([FromQuery] int startat, [FromQuery] int quantity, [FromQuery] string fieldFilter, [FromQuery] string fieldValue, [FromQuery] string orderField, [FromQuery] string order) {
