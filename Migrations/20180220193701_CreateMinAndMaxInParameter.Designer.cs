...
namespace recipeservice.Migrations
{
    ...
    [Migration("20180220193701_CreateMinAndMaxInParameter")]
    partial class CreateMinAndMaxInParameter
    {
            ...
            modelBuilder.Entity("recipeservice.Model.PhaseParameter", b =>
                {
                    ...
                    b.Property<string>("setupValueMax")
                        .HasMaxLength(50);

                    b.Property<string>("setupValueMin")
                        .HasMaxLength(50);
